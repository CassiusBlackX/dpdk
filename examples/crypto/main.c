/* minimal_crypto.c
 *
 * Minimal DPDK crypto example: AES-CBC-128 encrypt a single mbuf buffer.
 *
 * Notes:
 *  - Tested conceptually with modern DPDK APIs; you may need to adapt small API differences
 *    for your DPDK version (esp. session creation / attach calls).
 *  - Requires a crypto PMD available on the host (or a software crypto PMD).
 *
