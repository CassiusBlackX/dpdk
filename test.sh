...
bash -c './build/app/dpdk-test-crypto-perf --file-prefix=dpdk1 -l 5-6 --vdev crypto_uadk -- --devtype crypto_uadk --cipher-algo aes-cbc --cipher-key-sz 32 --cipher-iv-sz 16 --cipher-op encrypt --optype cipher-only --silent --total-ops 2048 --buffer-sz 2048 --burst-sz 1' 
